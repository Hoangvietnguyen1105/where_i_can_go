...
import { Configurator } from "./car-puzzle-master/configtor/configtor";
import { PlayScene } from "./car-puzzle-master/scenes/playScene";
import { SoundManager } from "./template/soundManager";
import { Physics } from "./physics/physics";
import { DataLocal, DataLocalEvent } from "./car-puzzle-master/data/dataLocal";
import { FPSRender } from "./libs/fpsRender";
import { LoadingScene } from "./car-puzzle-master/scenes/loadingScene";
import { DataManager } from "./car-puzzle-master/data/dataManager";
import { RenderPhysicLoader } from "./libs/render-physic";
...
export class Game {
  ...
  static create() {
    ...
    SceneManager.init([new LoadingScene(), new PlayScene()]);
